...
(
    ...
    mv riak_cs/.??* .
    rmdir riak_cs
    git checkout feature/bench-driver-cosmetics
...
erlc -o deps.riak-cs/ebin $RIAK_CS_SRC_DIR/bench/basho_bench_driver_cs.erl
erlc -o deps.riak-cs/ebin -I $RIAK_CS_SRC_DIR/deps/velvet/include $RIAK_CS_SRC_DIR/deps/velvet/src/stanchion_auth.erl

cp $RIAK_CS_SRC_DIR/bench/riak-cs.config.sample examples/riak-cs.config
